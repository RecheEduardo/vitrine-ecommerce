  ...
  if (isMobile) {
    return (
      <nav className="flex flex-col items-start p-4">
        <a href="#" className="py-3 text-sm font-bold w-full text-dark-blue mb-3 border-b border-dark-blue">TODAS CATEGORIAS</a>
    ...
    >
      <div className="container mx-auto flex justify-center items-center">
        <div className="flex items-center gap-8">
          <motion.div
            className="flex items-center font-semibold xl:gap-32 lg:gap-12" // reduzido o gap para caber mais itens
