...
const ParceiroCard = () => (
  ...
  >
    ...
    <div className="relative h-full flex flex-col justify-end gap-5 p-12 text-white">
      ...
      <motion.h3 className="text-5xl font-bold" {...popInItemMotionProps}>
        Parceiros
      </motion.h3>
      
      <motion.p className="text-lg mt-1" {...popInItemMotionProps}>
        Lorem ipsum dolor sit <br/> amet, consectetur
      </motion.p>
      
      <motion.button className="mt-4 text-2xl bg-secondary text-black font-bold py-2 px-8 
